...
const B = "hsl(213 90% 60%)";    // soft blue accent
const DIM = "hsl(213 25% 38%)";  // muted text
            ...
            {isCreate && createdCode ? (
              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                {isCreate ? (
                  ...
                  <Field label="Room code" placeholder="ROOM-XXXX" value={roomCode} onChange={setRoomCode} testId="input-join-room-code" mono />
                )}
                <Field
                  label="Your name"
                ...
                <div className="pt-1">
                  ...
                  >
                    {isCreate ? "Create room" : "Join"} <ArrowRight className="w-4 h-4" />
                  </button>
                </div>
              </motion.div>
            )}
